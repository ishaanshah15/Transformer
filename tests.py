...
class TestDecoder(unittest.TestCase):
    ...
    def setUp(self):
        seed_everything(SEED)
        self.layer = transformer.Decoder(30, 30, 5, 3)
...
class TestBeamSearch(unittest.TestCase):
    ...
    def test(self):
        ...
        x = [2, 25, 26, 3193, 233, 132, 16, 1337, 5, 3, 3796, 3796]
        for b in range(1, 6):
        ...
        x = [2, 5, 4, 6, 8, 10, 12, 14, 3, 3796, 3796, 3796]
        ...
        x = [2, 10, 20, 30, 40, 50, 60, 70, 80, 90, 3, 3796]
